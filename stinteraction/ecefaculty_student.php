...
<h1 style="color:green;"> <center> <br><br>ECE STUDENT DETAILS </center> </h1>
<?php
...
$result =mysqli_query($con,"select * from register_table where deptname='ECE' and regmember='student'");
