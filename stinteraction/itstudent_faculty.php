...
<h1 style="color:green;"> <center> <br><br>IT STAFF DETAILS </center> </h1>
<?php
...
$result =mysqli_query($con,"select * from register_table where deptname='IT' and regmember='faculty'");
