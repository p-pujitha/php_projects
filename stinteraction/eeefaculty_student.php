...
<h1 style="color:green;"> <center> <br><br>EEE STUDENT DETAILS </center> </h1>
<?php
...
$result =mysqli_query($con,"select * from register_table where deptname='EEE' and regmember='student'");
