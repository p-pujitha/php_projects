    ...
    function go_there(button)
{
  ...
  if (where_to== true)
  {
    window.location="lets_student_chat.php?receivername=" + name;
  }
}
...
<h1 style="color:green;"> <center> <br><br>EEE STAFF DETAILS </center> </h1>
<?php
...
$result =mysqli_query($con,"select * from register_table where deptname='EEE' and regmember='faculty'");
...
<td><INPUT TYPE="button" value="Lets Chat!!!" onClick="go_there(this)" data-name="<?php echo $rows[0] ?>"> </INPUT></td>
</tr>
